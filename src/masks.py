...
def get_mask_account(account_number: int) -> str:
    """Возвращает маскированный номер счета в формате: **XXXXXXXXXXXXXXXXXXX. Отображаются последние 18 цифр (2+18),
    первые 2 цифры заменяются на "**", за ними следуют ещё цифры "XXXXXXXXXXXXXXXXXXX",
    и последние 18 цифр номера отображаются без маски.
